...
dist_max_x = 5# .8/n_camada #(0.4) onsiderando uma celula (fundamental) de lado l=1
#print('d_max_x',dist_max_x)
dist_max_y = 4 
#print('d_max_y',dist_max_y)
dist_max_z = 2 #.5/n_camada
...
#estipulando o valor maximo inicial como o primeiro elemento do vetor
val_max = ang_eq_aux[0]

#loop de procura pelo maior valor
for i in range(len(ang_eq_aux)):
    
    #comparando cada elemento do vetor como numero maximo
    if (ang_eq_aux[i] > val_max):
        
        #se sim --> novo valor maximo abaixo
        val_max = ang_eq_aux[i]
...
#estipulando o valor minimo inicial como o primeiro elemento do vetor
val_min = ang_eq_aux[0]

#loop de procura pelo menor valor
for i in range(len(ang_eq_aux)):
    
    #comparando cada elemento do vetor como numero minimo
    if (ang_eq_aux[i] < val_min):
        
        #se sim --> novo valor maximo abaixo
        val_min = ang_eq_aux[i]
...
#estipulando o valor maximo inicial como o primeiro elemento do vetor
val_max = ang_api_aux[0]

#loop de procura pelo maior valor
for i in range(len(ang_api_aux)):
    
    #comparando cada elemento do vetor como numero maximo
    if (ang_api_aux[i] > val_max):
        
        #se sim --> novo valor maximo abaixo
        val_max = ang_api_aux[i]
...
#estipulando o valor minimo inicial como o primeiro elemento do vetor
val_min = ang_api_aux[0]

#loop de procura pelo menor valor
for i in range(len(ang_api_aux)):
    
    #comparando cada elemento do vetor como numero minimo
    if (ang_api_aux[i] < val_min):
        
        #se sim --> novo valor maximo abaixo
        val_min = ang_api_aux[i]
...
#with open("output_XM_n2_interf.dat", "w") as f:
#with open("GeBr_XB_n2_interf.dat", "w") as f:
with open("XM_n2_interf.dat", "w") as f:
#with open("GeI_XM_n2_interf.dat", "w") as f:
#with open("Sn_XM_n2_interf.dat", "w") as f:
...
#Inter-face
#vetor de dados de formato: [no_camadas; dist_max_equa; dist_min_equa; dist_max_api; dist_min_api]
result_interf = np.array([ n_camada, ang_eq_min, ang_eq_max , ang_api_min, ang_api_max ])
##print(result_interf)
...
# Criando arquivo xyz com os resultado
csv.register_dialect('myDialect', delimiter = ' ', quoting=csv.QUOTE_NONE, skipinitialspace=True)
#with open("output_MXM_n2_interf.dat", "w") as f:
#with open("GeBr_BXB_n2_interf.dat", "w") as f:
with open("MXM_n2_interf.dat", "w") as f:
#with open("GeI_MXM_n2_interf.dat", "w") as f:
#with open("Sn_MXM_n2_interf.dat", "w") as f:
    writer = csv.writer(f, dialect='myDialect')
    writer.writerow(data)
...
Cabec = [[n_Atomos],[]]
csv.register_dialect('myDialect', delimiter = ' ', quoting=csv.QUOTE_NONE, skipinitialspace=True)
with open("interf_delta_d_n_2.dat", "w") as f:
...
Cabec = [[n_Atomos],[]]
csv.register_dialect('myDialect', delimiter = ' ', quoting=csv.QUOTE_NONE, skipinitialspace=True)
with open("interf_theta_n_2.dat", "w") as f:
    writer = csv.writer(f, dialect='myDialect')
